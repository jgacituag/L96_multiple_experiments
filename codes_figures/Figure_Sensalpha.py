...
def plot_RMSE_sensitivity_to_alpha(base_path,output_dir,obs,freq,den,nen,gec,vmin=0,vmax=2):
    ...
    output_dir = f"{output_dir}/RMSE_Alpha_Sensitivity"
    ...
    figname = f"RMSE_Alpha_Sensitivity_Freq{freq}_Den{den}_Type3_nens{nen}_ObsErr{obs}_{gec}"
...
for obs_err in obs_errs:
    for nen in nens:
        plot_RMSE_sensitivity_to_alpha(base_path,output_dir,obs_err,freq,den,nen,gec,vmin=0,vmax=2)
