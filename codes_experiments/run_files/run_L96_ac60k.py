...
conf.DAConf['ExpLength'] = 60000                           #None use the full nature run experiment. Else use this length.
...
out_filename = f'/home/jorge.gacitua/salidas/L96_multiple_experiments/data/LETKF/LETKF_{nature_name}_Nens{nens}_NTemp{ntemp}_alpha{AlphaTempScale}{gec}_60k.npz'
